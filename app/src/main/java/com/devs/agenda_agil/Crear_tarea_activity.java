...
public class Crear_tarea_activity extends AppCompatActivity {
        ...
        crearTarea.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nombreDeLaTarea.matches("") || nombreDeLaTarea.matches(" ") || nombreDeLaTarea.matches("  ")) {
                    Toast.makeText(Crear_tarea_activity.this, "¡Debés ingresar un nombre de tarea!", Toast.LENGTH_SHORT).show();
                }
                else {
                    Intent intent = new Intent(v.getContext(), MainActivity.class);
                    intent.putExtra("nombreT", nombreDeLaTarea);
                    intent.putExtra("prioridadT", 1);
                    Toast.makeText(Crear_tarea_activity.this, "Tarea creada con éxito. ;)", Toast.LENGTH_SHORT).show();
